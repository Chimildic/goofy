...
Goofy это набор предопределенных функций, библиотека JavaScript. Она позволяет вам не задумываться о том, как взаимодействовать с внешними сервисами, как составлять запросы, получать результаты, модифицировать массивы треков. Черный ящик, который что-то принимает на входе и выдает результат. Название библиотеки образовано от сочетания начальных букв Google и окончания от Spotify.
