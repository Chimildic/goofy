...
Проект легко расширить. Доступно [управление с телефона](https://github.com/Chimildic/goofy/discussions/9), внедрение своих алгоритмов. Например, [импорт с интернет-радио di.fm](https://github.com/Chimildic/goofy/discussions/57) или любого другого источника.
