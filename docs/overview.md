...
<div style="display: flex; justify-content: space-between; flex-wrap: wrap; margin: 0 0 2em 0">
  <div><a target="_blank" href="https://unsplash.com/photos/8e0EHPUx3Mo"><img width="200px" style="border-radius: 10px; margin: 0 0 0 0" src="/img/pls-cover-1.jpg"></a> </div>
  <div>
    ...
    <ul>
      ...
      <li>импортирует <a target="_blank" href="https://chimildic.github.io/goofy/#/addon?id=Импорт-треков-с-радио">FM-радио</a> и <a target="_blank" href="https://www.last.fm/ru/about">Last.fm</a></li>
  ...
  <div><a target="_blank" href="https://unsplash.com/photos/wejxKZ-9IZg"><img width="200px" style="border-radius: 10px; margin: 0 0 0 0" src="/img/pls-cover-2.jpg"></a> </div>
</div> 
...
goofy это черный ящик, который что-то принимает на входе и выдает результат. Состоит из набора функций на JavaScript. Они позволяют вам не задумываться о том, как взаимодействовать с внешними сервисами, составлять запросы, получать результаты, модифицировать массивы. 

Вы будете создавать свои функции, которые исполнит платформа Google Apps Script. Грубо говоря, она позволяет писать макросы для сервисов Google: документы, таблицы, диск, почта и прочее. На ряду с ними предоставляя доступ к внешним сервисам. Имеет механизм триггеров - расписание, которое определяет когда и что запустить.
...
?> При установке или изменении версии, отправляется единичный запрос в Google Формы. Чтобы иметь представление сколько пользователей активно используют библиотеку.
...
Возможность goofy отслеживать историю появляется за счет платформы Apps Script и её доступа к Google Drive. Каждые 15 минут, goofy переодически обращается к Spotify и обновляет содержимое файла на диске новыми данными.
