...
- [#162](https://github.com/Chimildic/goofy/issues/162) Аддон определения и фильтрации основного языка трека перенесен в основной код [Filter.detectLanguage](/func?id=detectlanguage).
...
- [Cache.append](/func?id=append) больше не добавляет данные в исходный массив (используйте [push](/func?id=push)). Добавляет только в кэш файл. Возвращает количество всех элементов после добавления.
