...
- Нужно обновить файл config:
  - Добавлен параметр локали при запросе плейлистов. В связи с [постом](https://github.com/Chimildic/goofy/discussions/79#discussioncomment-814744): кириллицеское название возвращалось на латинице.
...
- [20.05.21] 
  ...
  - Order.sort может сортировать массимы исполнителей и альбомов.
  - Новая функция [Playlist.removeTracks](/func?id=removetracks-1).
  - [getTracks](/func?id=gettracks) может выбирать ограниченое количество треков из плейлистов.
