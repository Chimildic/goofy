...
Перед использованием шаблонов рекомендуется ознакомиться с обучением по созданию [первого плейлиста](/first-playlist). Значительно упростит работу с шаблонами, ответит на частые вопросы. Дополнительные шаблоны найдете на [форуме](https://github.com/Chimildic/goofy/discussions).
