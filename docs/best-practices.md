...
Файлы от [Cache](/reference/cache) хранятся на [Google Диске](https://drive.google.com/). В том числе [история прослушиваний](/overview?id=История-прослушиваний). Удаленный файл попадает в корзину, где доступен еще 30 дней. Каждый файл имеет до 100 версий. Каждая запись в один и тот же файл создает новую версию. 
