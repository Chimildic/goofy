...
!> Количество элементов в `source` должно соответствовать количеству элементов `inRow`. То есть каждому массиву назначается число подряд идущих элементов.
...
!> Если трек не содержит даты, устанавливается 01.01.2000. Такое возможно, например, если трек добавлен в Spotify очень давно, источником является [getTopTracks](/func?id=gettoptracks), это плейлисты "Мой микс дня #N" или ряд других источников.
